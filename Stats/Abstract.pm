...
MARC::Collection::Stats::Abstract - Abstract class for MARC::Collection::Stats plugins.

=head1 SYNOPSIS

 my $obj = MARC::Collection::Stats::Plugin::Foo->new;
 $obj->init;
 my $name = $obj->name;
...
This is abstract class for L<MARC::Collection::Stats> plugins, which are used in
L<App::MARC::Collection::Stats> tool.

=head1 METHODS

=head2 C<new>

 my $obj = MARC::Collection::Stats::Abstract->new(%params);
...
=for comment filename=example_plugin.pl
 ...
 package MARC::Collection::Stats::Plugin::Foo;
 ...
 # Output structure:
 # {
 #     datetime         "2025-04-14T21:25:49" (dualvar: 2025),
 #     module_name      "MARC::Collection::Stats::Plugin::Foo",
 #     module_version   1.01,
 #     name             "foo",
 #     stats            {
 #         bar_stat   2,
